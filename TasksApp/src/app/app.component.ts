import { ChangeDetectorRef, Component, Inject, OnDestroy, OnInit, WritableSignal, signal } from '@angular/core';
...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, MatButtonModule, MatIconModule, MatToolbarModule, MsalModule, RouterLink, RouterOutlet],
